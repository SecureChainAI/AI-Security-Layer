...
contract BactrianCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BactrianCoin() {
        ...
        name = "BactrianCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BTAC";                                             // Set the symbol for display purposes (CHANGE THIS)
