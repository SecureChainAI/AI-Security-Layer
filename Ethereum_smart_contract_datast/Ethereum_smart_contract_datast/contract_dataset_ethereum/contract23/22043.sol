...
contract KOKOCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KOKOCoin() {
        ...
        name = "KOKOCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "KOKOC";                                             // Set the symbol for display purposes (CHANGE THIS)
