...
contract Game is FixedSupplyToken {
    HourglassInterface constant P3Dcontract_ =
        HourglassInterface(0xB3775fB83F7D12A36E0475aBdD1FCA35c091efBe);
    struct Village {
        address owner;
        uint defending;
        uint lastcollect;
    ...
    function harvestabledivs() public view returns (uint256) {
    ...
    function villageinfo(
        ...
        returns (
            address owner,
            uint256 soldiersdefending,
            uint256 lastcollect,
            uint256 beginnersprotection
        )
    {
        return (
            roundownables[round].villages[lookup].owner,
            roundownables[round].villages[lookup].defending,
            roundownables[round].villages[lookup].lastcollect,
            roundownables[round].villages[lookup].beginnerprotection
        );
    }

    function gotchinfo(address lookup) public view returns (uint256 Gold) {
        return (roundownables[round].GOTCH[lookup]);
    }

    function soldiersinfo(
        address lookup
    ) public view returns (uint256 soldiers) {
        return (roundownables[round].soldiers[lookup]);
    }

    function redeemablevilsinfo(
        address lookup
    ) public view returns (uint256 redeemedvils) {
    ...
    function playerinfo(
        ...
        view
        returns (
            uint256 redeemedvils,
            uint256 redeemablevils,
            uint256 soldiers,
            uint256 GOTCH
        )
    {
    ...
    function attackhill(
        ...
        if (msg.sender == roundownables[round].hillowner) {
            roundownables[round].soldiersdefendinghill = roundownables[round]
                .soldiersdefendinghill
                .add(amtsoldiers);
            roundownables[round].soldiers[msg.sender] = roundownables[round]
                .soldiers[msg.sender]
                .sub(amtsoldiers);
            return (false, 0);
        }
        if (msg.sender != roundownables[round].hillowner) {
            if (roundownables[round].soldiersdefendinghill < amtsoldiers) {
                ...
                emit battle(
                    msg.sender,
                    roundownables[round].soldiersdefendinghill,
                    roundownables[round].hillowner,
                    roundownables[round].soldiersdefendinghill
                );
                roundownables[round].hillowner = msg.sender;
                roundownables[round].soldiersdefendinghill = amtsoldiers.sub(
                    roundownables[round].soldiersdefendinghill
                );
                roundownables[round].soldiers[msg.sender] = roundownables[round]
                    .soldiers[msg.sender]
            ...
            if (roundownables[round].soldiersdefendinghill >= amtsoldiers) {
                roundownables[round].soldiersdefendinghill = roundownables[
                    round
                ].soldiersdefendinghill.sub(amtsoldiers);
                roundownables[round].soldiers[msg.sender] = roundownables[round]
                    .soldiers[msg.sender]
                    .sub(amtsoldiers);
                emit battle(
    ...
    function updatesolsforhire() internal {
        roundvars[round].solsforhire = roundvars[round].solsforhire.add(
            (block.number.sub(roundvars[round].solslastupdate))
                .mul(roundvars[round].nextVillageId)
                .mul(roundvars[round].soldierreplenishrate)
        );
        roundvars[round].solslastupdate = block.number;
    }
    ...
    function updatesolbuyrate() internal {
        ...
        roundvars[round].soldierprice = roundvars[round].totalsupplyGOTCH.div(
            roundvars[round].solsforhire
        );
    ...
    function buysoldiers(uint256 amount) public payable {
        ...
        roundownables[round].GOTCH[msg.sender] = roundownables[round]
            .GOTCH[msg.sender]
            .sub(amount.mul(roundvars[round].soldierprice));
        roundvars[round].GOTCHatcontract = roundvars[round].GOTCHatcontract.add(
            amount.mul(roundvars[round].soldierprice)
        );
    }
    ...
    function createvillage() public payable {
        ...
        roundownables[round]
            .villages[roundvars[round].nextVillageId]
            .owner = msg.sender;
        ...
        roundownables[round]
            .villages[roundvars[round].nextVillageId]
            .beginnerprotection = block.number;
        roundvars[round].nextVillageId++;

        roundownables[round]
            .villages[roundvars[round].nextVillageId]
            .defending = roundvars[round].nextVillageId;
    ...
    function batchcreatevillage(uint256 amt) public payable {
        ...
        roundownables[round].redeemedvils[msg.sender] = roundownables[round]
            .redeemedvils[msg.sender]
            .add(amt);
    }
    ...
    function attack(
        ...
        if (
            block.number >
            roundvars[round].lastblockpayout +
                roundvars[round].blocksbeforenewpay
        ) {
            hillpayout();
        }

        uint bpcheck = roundownables[round]
            .villages[village]
            .beginnerprotection
            .add(roundvars[round].bpamount);
        ...
        if (msg.sender == roundownables[round].villages[village].owner) {
            roundownables[round].villages[village].defending = roundownables[
                round
            ].villages[village].defending.add(amtsoldiers);
            roundownables[round].soldiers[msg.sender] = roundownables[round]
                .soldiers[msg.sender]
                .sub(amtsoldiers);
            return (false, 0);
        ...
        if (msg.sender != roundownables[round].villages[village].owner) {
            if (
                ...
                emit battle(
                    msg.sender,
                    roundownables[round].villages[village].defending,
                    roundownables[round].villages[village].owner,
                    roundownables[round].villages[village].defending
                );
                emit villtakeover(
                    roundownables[round].villages[village].owner,
                ...
                roundownables[round].villages[village].defending = amtsoldiers
                    .sub(roundownables[round].villages[village].defending);
                roundownables[round].soldiers[msg.sender] = roundownables[round]
                    .soldiers[msg.sender]
                    .sub(amtsoldiers);
    ...
    function support(uint256 village, uint256 amtsoldiers) public payable {
        ...
        require(amtsoldiers <= roundownables[round].soldiers[msg.sender]);
        require(amtsoldiers >= 1);
        roundownables[round].villages[village].defending = roundownables[round]
            .villages[village]
            .defending
            .add(amtsoldiers);
        roundownables[round].soldiers[msg.sender] = roundownables[round]
    ...
    function renewbeginnerprotection(uint256 village) public payable {
        require(
            msg.value >=
                (roundvars[round].nextVillageId.sub(village)).mul(1 finney)
        ); //
        roundownables[round].villages[village].beginnerprotection = block
            .number;
    }

    function batchcollecttaxes(
        uint256 a,
        uint256 b,
        uint256 c,
        uint256 d,
        ...
        uint256 test = (
            block.number.sub(roundownables[round].villages[a].lastcollect)
        ).mul((roundvars[round].nextVillageId.sub(a)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
            roundvars[round].totalsupplyGOTCH = roundvars[round]
                .totalsupplyGOTCH
                .add(test);
        }
        roundownables[round].GOTCH[msg.sender] = roundownables[round]
            .GOTCH[msg.sender]
            .add(test);
        roundvars[round].GOTCHatcontract = roundvars[round].GOTCHatcontract.sub(
            test
        );
        ...
        test = (block.number.sub(roundownables[round].villages[b].lastcollect))
            .mul((roundvars[round].nextVillageId.sub(b)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
        ...
        test = (block.number.sub(roundownables[round].villages[c].lastcollect))
            .mul((roundvars[round].nextVillageId.sub(c)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
        ...
        test = (block.number.sub(roundownables[round].villages[j].lastcollect))
            .mul((roundvars[round].nextVillageId.sub(j)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
        ...
        test = (block.number.sub(roundownables[round].villages[d].lastcollect))
            .mul((roundvars[round].nextVillageId.sub(d)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
        ...
        test = (block.number.sub(roundownables[round].villages[e].lastcollect))
            .mul((roundvars[round].nextVillageId.sub(e)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
        ...
        test = (block.number.sub(roundownables[round].villages[f].lastcollect))
            .mul((roundvars[round].nextVillageId.sub(f)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
        ...
        test = (block.number.sub(roundownables[round].villages[g].lastcollect))
            .mul((roundvars[round].nextVillageId.sub(g)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
        ...
        test = (block.number.sub(roundownables[round].villages[h].lastcollect))
            .mul((roundvars[round].nextVillageId.sub(h)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
        ...
        test = (block.number.sub(roundownables[round].villages[i].lastcollect))
            .mul((roundvars[round].nextVillageId.sub(i)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
    ...
    function collecttaxes(uint256 village) public payable returns (uint) {
        ...
        require(roundownables[round].villages[village].owner == msg.sender);
        require(
            block.number > roundownables[round].villages[village].lastcollect
        );
        uint256 test = (
            block.number.sub(roundownables[round].villages[village].lastcollect)
        ).mul((roundvars[round].nextVillageId.sub(village)));
        if (roundvars[round].GOTCHatcontract < test) {
            roundvars[round].GOTCHatcontract = roundvars[round]
                .GOTCHatcontract
                .add(test);
    ...
    function sellDOTCH(uint amt) public payable {
        require(msg.value >= 1 finney);
        ...
        roundownables[round].GOTCH[this] = roundownables[round].GOTCH[this].sub(
            amt.mul(10000)
        );
        roundownables[round].GOTCH[msg.sender] = roundownables[round]
            .GOTCH[msg.sender]
    ...
    function buyDOTCH(uint amt) public payable {
        require(msg.value >= 1 finney);
        require(roundownables[round].ERCtradeactive == true);
        ...
        roundownables[round].GOTCH[msg.sender] = roundownables[round]
            .GOTCH[msg.sender]
            .sub(amt.mul(10000));
        roundownables[round].GOTCH[this] = roundownables[round].GOTCH[this].add(
            amt.mul(10000)
        );
    }
    ...
    function adddotchtooffer(uint256 ordernumber, uint256 dotchamount) public {
        ...
        balances[this] = balances[this].add(dotchamount);
        emit Transfer(msg.sender, this, dotchamount);
        marketplace[ordernumber].amountdotch = marketplace[ordernumber]
            .amountdotch
            .add(dotchamount);
    }

    function removedotchtooffer(
        uint256 ordernumber,
        uint256 dotchamount
    ) public {
        require(dotchamount > 0);
    ...
    function takeoffer(uint256 ordernumber, uint256 amtdotch) public payable {
        require(
            msg.value >=
                marketplace[ordernumber].wantsthisamtweiperdotch.mul(amtdotch)
        );
        require(amtdotch > 0);
        ...
        emit dotchsale(
            marketplace[ordernumber].placedby,
            marketplace[ordernumber].wantsthisamtweiperdotch,
            msg.sender,
            amtdotch
        );
        marketplace[ordernumber].placedby.transfer(
            marketplace[ordernumber].wantsthisamtweiperdotch.mul(amtdotch)
        );
    }
    ...
    function startnewround() public {
        ...
        roundvars[round].previousethamount = roundvars[round - 1]
            .previousethamount;
