...
contract MELTTokenFundraiser is MintableTokenFundraiser, IndividualCapsFundraiser, CappedFundraiser, ForwardFundsFundraiser, GasPriceLimitFundraiser {
    ...
    public
  {
    ...
    initializeBasicFundraiser(
      1530019200, // Start date = 26 Jun 2018 13:20 UTC
      1541016000,  // End date = 31 Oct 2018 20:00 UTC
      10000, // Conversion rate = 10000 MELT per 1 ether
