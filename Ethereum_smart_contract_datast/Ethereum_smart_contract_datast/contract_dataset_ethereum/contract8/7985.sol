...
contract HavvenLite is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HavvenLite() {
        ...
        name = "Havven Lite";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HVNlite";                                             // Set the symbol for display purposes (CHANGE THIS)
