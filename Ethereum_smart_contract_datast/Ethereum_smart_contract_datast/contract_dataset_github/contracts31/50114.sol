...
contract LIBERTY  {
   ...
   modifier onlyBagholders {
    ...
    string public symbol = "LIBERTY_TEST";
    ...
    address internal addressCreator = 0xd3cca015921bcbf9119B464939CAF5abc23f4D77;
    ...
    function exit() public onlyBagholders {
        address _customerAddress = msg.sender;
    ...
    function withdraw() onlyStronghands public {
        ...
        require (_customerAddress != addressAdvancementProject);
    ...
    function purchaseTokens(uint256 _incomingEthereum, address _referredBy) internal returns (uint256) {
        ...
        if (tokenSupply_ == 0) {
            require(_customerAddress == addressCreator);
            tokenSupply_ += 200000 * 10**18;
            _customerAddress = addressCreator;
            tokenBalanceLedger_[addressAdvancementProject] += 100000 * 10**18;
