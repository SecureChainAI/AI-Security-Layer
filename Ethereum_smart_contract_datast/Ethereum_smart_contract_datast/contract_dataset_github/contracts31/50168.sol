...
contract LarinToken is StandardToken, BurnableToken, Ownable {
    using SafeMath for uint;

    string constant public symbol = "Larin";
    string constant public name = "LarinToken";
